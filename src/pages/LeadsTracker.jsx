  ...
  return (
    <main className="max-w-5xl mx-auto py-10 px-2 md:px-0">
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-3xl font-bold text-blue-900">Leads Tracker</h1>
        ...
        <table className="min-w-full text-xs md:text-sm">
          <thead>
            <tr className="bg-blue-100 text-blue-900">
              ...
              <th className="px-2 py-2">Tgt-1</th>
              <th className="px-2 py-2">Tgt-2</th>
              <th className="px-2 py-2">Res-1</th>
              <th className="px-2 py-2">Res-2</th>
              <th className="px-2 py-2">SL-1</th>
              <th className="px-2 py-2">SL-2</th>
          ...
          <tbody>
            {leads.length === 0 ? (
              <tr><td colSpan={13} className="text-center text-gray-400 py-4">No leads yet.</td></tr>
            ) : (
              leads.map((lead, i) => (
                <tr key={i} className="odd:bg-white even:bg-blue-50">
                  <td className="px-2 py-2 font-semibold text-blue-800">
                    <a href={`/stock/${lead.symbol}`} className="hover:underline text-blue-700" title="Go to Stock Details">{lead.symbol}</a>
                  </td>
                  <td className="px-2 py-2">{lead.action}</td>
                  <td className="px-2 py-2">{lead.tgt1}</td>
                  <td className="px-2 py-2">{lead.tgt2}</td>
                  <td className="px-2 py-2">{lead.res1}</td>
                  <td className="px-2 py-2">{lead.res2}</td>
                  <td className="px-2 py-2">{lead.sl1}</td>
                  <td className="px-2 py-2">{lead.sl2}</td>
                  <td className="px-2 py-2">{lead.category}</td>
                  <td className="px-2 py-2">{lead.closeDate}</td>
                  <td className="px-2 py-2 max-w-xs truncate" title={lead.reasons}>{lead.reasons}</td>
